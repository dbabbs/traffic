...
const colorFormats = [StringEncodedNumeral_1.StringEncodedHSL, StringEncodedNumeral_1.StringEncodedHex, StringEncodedNumeral_1.StringEncodedRGB, StringEncodedNumeral_1.StringEncodedRGBA];
...
exports.StringEncodedRGBA = {
    ...
    decoder: (encodedValue) => {
        const channels = exports.StringEncodedRGBA.regExp.exec(encodedValue);
    ...
    processLineFeature(layer, extents, geometry, context, techniques, featureId) {
        ...
        for (const technique of techniques) {
            ...
            if (harp_datasource_protocol_1.isLineTechnique(technique) ||
                ...
                this.applyLineTechnique(lineGeometry, technique, techniqueIndex, this.m_gatherFeatureIds, lineType, featureId, lines, context, this.getTextureCoordinateType(technique) ? uvs : undefined, hasUntiledLines ? offsets : undefined);
            }
            else if (harp_datasource_protocol_1.isTextTechnique(technique) ||
